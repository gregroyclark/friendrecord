...
const Navbar = () => {
  return (
    <div className="fixed z-[100] flex h-24 w-full items-center">
      <div className="mb-4 flex h-full w-full items-center justify-between bg-[#E4E2DD] p-2 shadow-md 2xl:px-16">
        <Link href={"/"}>
          <img
            src={logo.src}
